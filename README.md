...
> **Warning**
> Сервис распознает ноты длительностью от 1/16 на **ОДНОМ** нотном стане. Если зарузить изображение с двумя и более нотными станами, сервис будет работать неккоректно. 
